...
const content = {
  ...
  mn: {
    title: 'Хөдөлмөрийн зөвшөөрөл хэрхэн авах вэ',
    subtitle: 'Шинэ EPOS порталын алхам алхмаар гарын авлага (2025 оны 4-р сард нээгдсэн)',
    newSystem: {
      badge: '2025 оны 4-р сард шинэчлэгдсэн',
      heading: 'Шинэ онлайн систем (EPOS)',
      body: 'DETE хуучин порталыг орчин үеийн cloud-д суурилсан Employment Permits Online System-ээр сольсон. Бүх өргөдөл — шинэ болон сунгалт — одоо энэ шинэ порталаар дамжина. Хуучин Trusted Partner Initiative цуцлагдсан.',
    },
    steps: [
      {
        icon: UserPlus,
        title: 'Порталын бүртгэл үүсгэх',
        color: 'blue',
        items: [
          'Ажил олгогч болон ажилтан хоёулаа epos.enterprise.gov.ie дээр тус тусдаа бүртгэл үүсгэх ёстой.',
          'Ажил олгогчид Revenue болон CRO баримт бичгийг өгч, Employment Permits Unit-ийн баталгаажуулалтыг хүлээх шаардлагатай.',
          'Нэг ажил олгогчийн бүртгэлд олон админ хамааруулж болно.',
          'Бүх бүртгэлд гар утсаар дамжуулан Multi-Factor Authentication (MFA) заавал шаардлагатай.',
        ],
      },
      {
        icon: Users,
        title: 'Хамтарсан өргөдөл эхлүүлэх',
        color: 'emerald',
        items: [
          'Өргөдлийг одоо хамтран бөглөнө — ажил олгогч өөрийн хэсгийг, ажилтан хувийн мэдээллээ шууд бөглөнө.',
          'Хоёр тал тус тусдаа бүртгэлээрээ дамжуулан нэг өргөдөл дээр бодит цагт хамтран ажиллана.',
          'Маягтыг имэйлээр солилцох шаардлагагүй болсон.',
        ],
      },
      {
        icon: PenLine,
        title: 'Дижитал гарын үсэг зурах',
        color: 'purple',
        items: [
          'Бүх тал портал дээр e-signature ашиглан өргөдөлд гарын үсэг зурна.',
          'Биет гарын үсэг эсвэл сканнердсан баримт бичиг шаардлагагүй.',
        ],
      },
      {
        icon: CreditCard,
        title: 'Өргөдлийн хураамж төлөх',
        color: 'amber',
        items: [
          'Хураамжийг өргөдөл илгээсний дараа порталаар онлайнаар төлнө.',
          'Хураамж баталгаажих хүртэл өргөдлийн статус "Awaiting Payment" гэж харагдана.',
        ],
      },
      {
        icon: Eye,
        title: 'Өргөдлөө хянах',
        color: 'indigo',
        items: [
          'Порталын бүртгэлд бодит цагийн статус шинэчлэлт харагдана: Draft, Awaiting Payment, Processing, Decision Issued.',
          'Гол бус дэлгэрэнгүй мэдээллийг (холбоо барих) шууд шинэчилж болно; гол өөрчлөлт нь баталгаажуулалт шаардана.',
          'Тусламж: epos@enterprise.gov.ie',
        ],
      },
    ],
    changed: {
      heading: 'Хуучин системтэй харьцуулахад юу өөрчлөгдсөн бэ',
      items: [
        { label: 'Хамтарсан онлайн өргөдөл', desc: 'Ажил олгогч, ажилтан хоёр нэг маягтыг хамтран бөглөнө.' },
        { label: 'Цахим гарын үсэг', desc: 'Бүрэн дижитал гарын үсэг, цаас эсвэл сканнердах шаардлагагүй.' },
        { label: 'MFA аюулгүй байдал', desc: 'Гар утасны баталгаажуулалт бүх бүртгэлийг хамгаална.' },
        { label: 'Trusted Partner Initiative цуцлагдсан', desc: 'Бүх ажил олгогч нэг л порталыг ашиглана, тэргүүн ээлжийн дараалал байхгүй.' },
        { label: 'Бодит цагийн хяналт', desc: 'Өргөдлийн байдлыг алхам бүрд яг таг мэдэх боломжтой.' },
        { label: 'Cloud дэд бүтэц', desc: 'Илүү найдвартай, хурдан боловсруулалтад зориулагдсан.' },
      ],
    },
    processing: {
      heading: 'Одоогийн боловсруулах хугацаа',
      asOf: '2026 оны 5-р сарын 26-ны байдлаар',
      source: 'DETE боловсруулах огноо',
      note: 'Өргөдлийг хүлээн авсан огнооны дарааллаар боловсруулна. Харуулсан огноо нь одоогоор боловсруулагдаж буй хамгийн сүүлийн өргөдлийг илэрхийлнэ.',
      rows: [
        { type: 'Critical Skills (шинэ)', date: '2026.05.11', lag: '~2 долоо хоног', speed: 'fast' },
        { type: 'Intra-Company Transfer (шинэ)', date: '2026.04.22', lag: '~5 долоо хоног', speed: 'medium' },
        { type: 'General болон бусад шинэ өргөдөл', date: '2026.03.08', lag: '~12 долоо хоног', speed: 'slow' },
        { type: 'Сунгалт (бүх төрөл)', date: '2026.02.28', lag: '~3 сар', speed: 'slow' },
    ...
    links: {
      ...
      info: 'DETE — Шинэ EPOS-ийн мэдээллийн хуудас',
      support: 'Техникийн тусламж: epos@enterprise.gov.ie',
    },
  },
  bn: {
    title: 'কীভাবে কর্মসংস্থান পারমিটের জন্য আবেদন করবেন',
    subtitle: 'নতুন EPOS পোর্টালের ধাপে ধাপে গাইড (এপ্রিল ২০২৫-এ চালু হয়েছে)',
    newSystem: {
      badge: 'এপ্রিল ২০২৫ আপডেট',
      heading: 'নতুন অনলাইন সিস্টেম (EPOS)',
      body: 'DETE পুরনো পোর্টালকে আধুনিক ক্লাউড-ভিত্তিক Employment Permits Online System দিয়ে প্রতিস্থাপন করেছে। সব আবেদন — নতুন এবং নবায়ন — এখন এই নতুন পোর্টালের মাধ্যমে করতে হবে। পুরনো Trusted Partner Initiative বাতিল হয়ে গেছে।',
    },
    steps: [
      {
        icon: UserPlus,
        title: 'পোর্টাল অ্যাকাউন্ট তৈরি করুন',
        color: 'blue',
        items: [
          'নিয়োগকর্তা এবং কর্মচারী উভয়কেই epos.enterprise.gov.ie-তে আলাদা পৃথক অ্যাকাউন্ট তৈরি করতে হবে।',
          'নিয়োগকর্তাদের Revenue এবং CRO ডকুমেন্টেশন প্রদান করতে হবে এবং অ্যাকাউন্ট সক্রিয় হওয়ার আগে Employment Permits Unit-এর যাচাইকরণের জন্য অপেক্ষা করতে হবে।',
          'একটি নিয়োগকর্তা অ্যাকাউন্টে একাধিক প্রশাসক নিয়োগ করা যায়।',
          'সব অ্যাকাউন্টের জন্য মোবাইল ফোনের মাধ্যমে Multi-Factor Authentication (MFA) বাধ্যতামূলক।',
        ],
      },
      {
        icon: Users,
        title: 'যৌথ আবেদন শুরু করুন',
        color: 'emerald',
        items: [
          'আবেদনগুলো এখন যৌথভাবে পূরণ করা হয় — নিয়োগকর্তা তাদের অংশ পূরণ করেন এবং কর্মচারী সরাসরি তাদের ব্যক্তিগত তথ্য প্রবেশ করান।',
          'উভয় পক্ষ তাদের পৃথক অ্যাকাউন্টের মাধ্যমে একই আবেদনে রিয়েল-টাইমে কাজ করেন।',
          'ফর্ম ইমেইলে আদান-প্রদান করার প্রয়োজন নেই।',
        ],
      },
      {
        icon: PenLine,
        title: 'ডিজিটালি স্বাক্ষর করুন',
        color: 'purple',
        items: [
          'সব পক্ষ পোর্টালের মাধ্যমে e-signature দিয়ে আবেদনে স্বাক্ষর করে।',
          'কোনো শারীরিক স্বাক্ষর বা স্ক্যান করা ডকুমেন্ট প্রয়োজন নেই।',
        ],
      },
      {
        icon: CreditCard,
        ...
        color: 'amber',
        items: [
          'আবেদন জমা দেওয়ার পর পোর্টালের মাধ্যমে অনলাইনে ফি প্রদান করা হয়।',
          'ফি নিশ্চিত না হওয়া পর্যন্ত আবেদনের অবস্থা "Awaiting Payment" দেখাবে।',
        ],
      },
      {
        icon: Eye,
        ...
        color: 'indigo',
        items: [
          'পোর্টাল অ্যাকাউন্টে রিয়েল-টাইম স্ট্যাটাস আপডেট দেখা যায়: Draft, Awaiting Payment, Processing, Decision Issued।',
          'অ-মূল বিবরণ (যোগাযোগের তথ্য) সরাসরি আপডেট করা যায়; মূল পরিবর্তনের জন্য ইউনিটের যাচাইকরণ প্রয়োজন।',
          'সহায়তা: epos@enterprise.gov.ie',
        ],
      },
    ],
    changed: {
      heading: 'পুরনো সিস্টেমের তুলনায় কী পরিবর্তন হয়েছে',
      items: [
        { label: 'যৌথ অনলাইন আবেদন', desc: 'নিয়োগকর্তা ও কর্মচারী একসাথে একই ফর্ম পূরণ করে।' },
        { label: 'ই-স্বাক্ষর', desc: 'সম্পূর্ণ ডিজিটাল স্বাক্ষর, কাগজ বা স্ক্যানিং দরকার নেই।' },
        { label: 'MFA নিরাপত্তা', desc: 'মোবাইল ফোন যাচাইকরণ সব অ্যাকাউন্ট রক্ষা করে।' },
        { label: 'Trusted Partner Initiative বাতিল', desc: 'সব নিয়োগকর্তা একই পোর্টাল ব্যবহার করে, কোনো অগ্রাধিকার সারি নেই।' },
        { label: 'রিয়েল-টাইম স্ট্যাটাস ট্র্যাকিং', desc: 'প্রতিটি ধাপে আপনার আবেদন ঠিক কোথায় আছে তা জানুন।' },
        { label: 'ক্লাউড-ভিত্তিক অবকাঠামো', desc: 'অধিক নির্ভরযোগ্যতা এবং দ্রুত প্রক্রিয়াকরণের জন্য ডিজাইন করা।' },
      ],
    },
    processing: {
      heading: 'বর্তমান প্রক্রিয়াকরণ সময়',
      asOf: '২৬ মে, ২০২৬ পর্যন্ত',
      source: 'DETE প্রক্রিয়াকরণ তারিখ',
      note: 'আবেদনগুলো প্রাপ্তির তারিখের ক্রম অনুসারে প্রক্রিয়া করা হয়। প্রদর্শিত তারিখগুলো বর্তমানে প্রক্রিয়াধীন সর্বশেষ আবেদনের।',
      rows: [
        { type: 'Critical Skills (নতুন)', date: '১১ মে ২০২৬', lag: '~২ সপ্তাহ', speed: 'fast' },
        { type: 'Intra-Company Transfer (নতুন)', date: '২২ এপ্রিল ২০২৬', lag: '~৫ সপ্তাহ', speed: 'medium' },
        { type: 'General ও অন্যান্য নতুন আবেদন', date: '৮ মার্চ ২০২৬', lag: '~১২ সপ্তাহ', speed: 'slow' },
        { type: 'নবায়ন (সব ধরনের)', date: '২৮ ফেব্রুয়ারি ২০২৬', lag: '~৩ মাস', speed: 'slow' },
    ...
    links: {
      ...
      info: 'DETE — নতুন EPOS তথ্য পৃষ্ঠা',
      support: 'প্রযুক্তিগত সহায়তা: epos@enterprise.gov.ie',
    },
  },
};
